...
| 2.5 [Dealing with NULLs when sorting](https://github.com/bibliodatos/SQLite_Cookbook/blob/main/chapter_2/2.5.sql)<BR>2.5.b Make NULLS sort last using DESC<BR>NON-NULL commission sorted ascending and all NULLS last<BR>NON-NULL commission sorted descending and all NULLS last<BR>NON-NULL commission sorted ascending and all NULLS first<BR>| No | [run 2.5.a](https://sqlime.org/#gist:537dc372b70fcf51f7192026d99c32c1) |
